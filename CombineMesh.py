...
INPUT2 = "3d-models/Rabbit_baby_two.stl"
OUTPUT = "3d-models/Rabbit_combined.stl"
...
twist_lock = mesh.Mesh.from_file(INPUT2)
...
combined.save(OUTPUT, mode=stl.Mode.ASCII)  # save as ASCII
